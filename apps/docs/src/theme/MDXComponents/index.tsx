...
import { ChannelList } from "@site/src/components/ChannelList";
import { BindableBadge } from "@site/src/components/BindableBadge";
...
const MDXComponents: MDXComponentsObject = {
  ...
  // custom tags injected globally for remark_custom_jsdoc_tags
  ChannelList,
  BindableBadge
};
